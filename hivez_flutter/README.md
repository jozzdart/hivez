...
🧩 Flutter utilities for [`hivez` package](https://pub.dev/packages/hivez), including Hivez and Hive CE Flutter bindings.

---

The following is adapted from the main [`hivez` package](https://pub.dev/packages/hivez) documentation:
